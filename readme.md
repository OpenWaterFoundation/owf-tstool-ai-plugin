...
This repository contains the Open Water Foundation TSTool AI Plugin. This plugin can be used to predict future water levels based on historical data and weather conditions using a custom DeepAR LSTM model. The plugin is designed to work with TSTool, a tool for processing time series data.
...
6.  Browse to the `cdss-dev/TSTool/git-repos/owf-tstool-ai-plugin/owf/tstool-plugin/owf-tstool-ai-plugin` folder
    and ***Select Folder***.
