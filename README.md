...
This plugin can be installed to enable commands that integrate TSTool with AI services.

TSTool is part of [Colorado's Decision Support Systems (CDSS)](https://www.colorado.gov/cdss).
See the following online resources:

*   [TSTool timesheets.com Plugin download page](https://software.openwaterfoundation.org/tstool-ai-plugin/)
*   [TSTool timesheets.com Plugin Documentation](https://software.openwaterfoundation.org/tstool-ai-plugin/latest/doc-user/)
  ...
  cdss-dev/                                  Recommended folder for CDSS product development.
    TSTool/                                  Recommended folder for TSTool development.
      git-repos/                             Recommended folder for TSTool product repositories.
        owf-tstool-ai-plugin/     Repository working files.
...
6.  Browse to the `cdss-dev/TSTool/git-repos/owf-tstool-ai-plugin/owf-tstool-ai-plugin` folder
    and ***Select Folder***.
